...
**► Full Allocate reference:** `Eval-allocate.md`
...
7. **Executable Requirements Ad-Lib Report:**
   ...
   **Phase 2 — CE / Pattern Assessment**
   ...
   Files read in this phase (in order):
   ```
   1. Eval-eai_subscribe.md                 — if EAI detected in Phase 1
   2. Eval-logic_bank_api.md                — rule type selection
   3. Eval-logic_bank_patterns.md           — anti-patterns, calling= wiring
   ```
   ...
   **Implementation Plan** *(ordered steps written before any file was changed)*:
   ...
   | CE Files Loaded | [Exact list of Eval-*.md files read] |
