...
governance: see Eval-governance.md — thresholds, red flags, score ranges, manager roll-up
---
...
STEP 6: Check Red Flag (see below) — read Eval-governance.md for full policy
...
See `Eval-governance.md` for full policy, thresholds, and manager roll-up guidance.
...
> See `Eval-governance.md` for full scoring guide.
