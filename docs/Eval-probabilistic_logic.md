...
prerequisites:
  ...
  - Eval-logic_bank_patterns.md (event signatures, logging, request pattern)
  - Eval-logic_bank_api.md (deterministic rule APIs)
---
...
2. **Eval-logic_bank_patterns.md** - Event signatures, logging, Request Pattern
3. **Eval-logic_bank_api.md** - Deterministic rule APIs
...
version: 3.0
date: November 21, 2025
source: Eval-probabilistic_logic.md
"""
...
For detailed LogicBank patterns, see Eval-logic_bank_patterns.md
For deterministic rules, see Eval-logic_bank_api.md
