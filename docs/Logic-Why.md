...
1. Use your **IDE code completion services** for logic declaration - just type `Rule.`   Your IDE and Python combine to enable [Python as a DSL](Tech-DSL.md){:target="_blank" rel="noopener"}. 
