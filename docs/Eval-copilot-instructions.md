...
## What is this?
TThis is Context Engineering for GenAI-Logic Projects (created into each project) - version 3.5. 
...
2. **`Eval-logic_bank_api.md`** - Deterministic rules API
...
3. **`Eval-probabilistic_logic.md`** - Probabilistic (AI) rules API
