...
| **[Use Case 4: Allocation System](https://www.genai-logic.com/#h.68i3e948ivkl)** <br> allo_dept_gl | genai-logic create --project_name=allo_dept_gl --db_url=sqlite:///samples/dbs/starter.sqlite | - Cost allocation to Depts / GL <br>- See [Cascade Allocation](Sample_Allo_Dept_GL_full.md){:target="_blank" rel="noopener"} |
| **[Use Case 4.1: NL Sytems](https://www.genai-logic.com/#h.68i3e948ivkl)** <br> customs_demo | genai-logic create --project_name=customs_demo --db_url=sqlite:///samples/dbs/starter.sqlite | - Complete Business Systems<br> - e.g., [Customs Surtax](Customs-readme-full.md){:target="_blank" rel="noopener"} |
