...
| **[Requirements From Interview](samples/requirements/RFI/RFI-transcript.md)** <br> basic_demo_rfi | 💬 paste samples/prompts/basic_demo_rfi.prompt | - Most of this prompt is fully specified (AI builds those parts directly, no questions asked)<br>- And requests interview ("Also, interview me to work out this general intent: ...")... AI interviews you on that part only, confirms before building<br>- Real transcript included |
