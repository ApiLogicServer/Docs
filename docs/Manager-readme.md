...
|----------|---------|-------------------|
| **[Allocation with AI Rules](https://www.genai-logic.com/#h.68i3e948ivkl)** <br> allo_dept_gl | genai-logic create --project_name=allo_dept_gl --db_url=sqlite:///samples/dbs/starter.sqlite | - [Cascade Allocation (Costs to Depts/GL)](Sample_Allo_Dept_GL_full.md){:target="_blank" rel="noopener"} <br> - AI Rules for fuzzy match to project |
