...
| **[Use Case 5: Allocation](https://www.genai-logic.com/#h.68i3e948ivkl)** <br> allo_dept_gl | genai-logic create --project_name=allo_dept_gl --db_url=sqlite:///samples/dbs/starter.sqlite | - Create complete SubSystems<br> - e.g., [With Cascade Allocation](Sample_Allo_Dept_GL_full/){:target="_blank" rel="noopener"} |
