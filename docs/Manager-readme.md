...
version info: 16.00.03 (04/12/2026)
...
| **[NL Business Systems](samples/requirements/customs_demo/docs/requirements/customs_demo/requirements.md)** <br> customs_demo | See [customs_demo](samples/requirements/customs_demo/docs/requirements/customs_demo/requirements.md) | - Complete Business Systems<br> - EAI (using XML), textual requirements |
